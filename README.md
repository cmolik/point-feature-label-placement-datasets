...
Alexander Wolff has provided example point sets used for an experimental comparison of a simulated annealing algorithm, a greedy algorithm, and a rule-based algorithm for the point labeling problem. 
...
## Real-world data stems from the following sources.
...
Luiz Antonio Nogueira Lorena has provided map labeling datasets
